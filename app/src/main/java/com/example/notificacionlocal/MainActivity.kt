...
createNot()
    ...
    private fun createNot()
    {
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)  {
        val name = "Canal 100"
        val descri = "canal de Notificacion"
...
val notificationManager : NotificationManager= getSystemService(NOTIFICATION_SERVICE) as
    ...
    private fun enviarNot() {
        val mensaje = "Ha pasado un tiempo desde tu última conexión. Vuelve para ver quién está esperándote."
        ...
        .setContentTitle("Buscando el Amor")
